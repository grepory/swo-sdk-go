...
// APIClient manages communication with the SolarWinds Observability REST API API v1.0
...
type APIClient struct {
	...
	ChangeeventsAPI *ChangeeventsAPIService

	EntitiesAPI *EntitiesAPIService

	EntitiesWebsitesAPI *EntitiesWebsitesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ChangeeventsAPI = (*ChangeeventsAPIService)(&c.common)
	c.EntitiesAPI = (*EntitiesAPIService)(&c.common)
	c.EntitiesWebsitesAPI = (*EntitiesWebsitesAPIService)(&c.common)
